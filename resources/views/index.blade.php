...
@section('content')
    ...
    <!-- main content  -->
    <section class="wrapper-xl bg-white" style="max-width: 800px;">


        <div class="row">
            <!-- Hardware  -->
            <div class="col-lg-6">
                <h4><i class="fa m-r-sm fa-server"></i> {{trans('orchid/monitor::monitor.Hardware.Title')}}
                </h4>
            ...
            <!-- Network  -->
            <div class="col-lg-6">
                <h4><i class="fa m-r-sm fa-exchange"></i> {{trans('orchid/monitor::monitor.Network.Title')}}
                </h4>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <h4>
                    <i class="fa m-r-sm fa-area-chart"></i> {{trans('orchid/monitor::monitor.CPU Load Average.Title')}}
                </h4>
            ...
            <div class="col-lg-6">
                <!-- Memory  -->
                <h4><i class="fa m-r-sm fa-sliders"></i> {{trans('orchid/monitor::monitor.Memory.Title')}}
                </h4>
        ...
        <div class="row">
            ...
            <div class="col-lg-12 widget-less-padding">
                <h4><i class="fa m-r-sm fa-database"></i> {{trans('orchid/monitor::monitor.Storage.Title')}}
                </h4>
        ...
        <div class="row">
            <div class="col-md-12">
                <h4><i class="fa m-r-sm fa-info"></i> {{trans('orchid/monitor::monitor.Info.Title')}}</h4>
                <div class="table-responsive">
                    <table class="table table-striped">
                        <tbody>
                        <tr>
